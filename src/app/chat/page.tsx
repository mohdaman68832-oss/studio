      ...
      <div className="px-6 space-y-4">
        {isMessagesLoading ? (
          ...
          <div className="py-24 text-center space-y-4 opacity-30 px-10">
            ...
            <p className="text-[10px] font-black uppercase tracking-[0.2em]">Inbox Empty</p>
            <p className="text-[9px] font-medium italic">Your direct messages will appear here.</p>
          </div>
        )}
      </div>
    </div>
